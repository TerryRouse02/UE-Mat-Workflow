...
if ([string]::IsNullOrWhiteSpace($Out)) {
    $Out = Join-Path $WorkflowRoot "viewer\tests\fixtures\ue-texture-sample-sources.t3d"
}
...
$CommandletLog = Join-Path $LogRoot "UEMatExportMetadata_TextureSampleSources.log"
...
Write-Host "TextureSample source sample written to $Out"
