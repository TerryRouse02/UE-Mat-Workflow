...
const requiredFiles = [
  ...
  'Scripts/Capture-CoreClipboardSample.ps1',
...
for (const token of ['NodeDb=', 'Out=', 'CoreClipboardOut=', 'MakeMaterialAttributesSampleOut=', 'TextureSampleSourcesOut=', 'UMaterialExpression', 'FJsonSerializer', 'functionAsset']) {
